...
extern uint16_t controller1_buttons;
uint8_t *controller1_ready = (uint8_t *) (&controller1_buttons) + 0x02;
extern uint16_t controller2_buttons;
uint8_t *controller2_ready = (uint8_t *) (&controller2_buttons) + 0x02;
#pragma zpsym("controller1_buttons")
#pragma zpsym("controller2_buttons")
